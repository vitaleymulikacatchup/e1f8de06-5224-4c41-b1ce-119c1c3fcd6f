...
export const metadata: Metadata = {
  title: "Grand Palais Hotel - Luxury Accommodation in the City",
  description: "Experience unparalleled luxury at Grand Palais Hotel with world-class amenities, fine dining, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, city accommodation, fine dining, spa, premium suites, business hotel",
  openGraph: {
    title: "Grand Palais Hotel - Luxury Accommodation",
    description: "Experience unparalleled luxury with world-class amenities and exceptional service",
    siteName: "Grand Palais Hotel",
    images: [
      {
        url: "https://images.pexels.com/photos/15447099/pexels-photo-15447099.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Grand Palais Hotel exterior"
      }
    ],
    type: "website"
  },
